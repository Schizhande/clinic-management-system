...
<div id="registrationbox" class="mainbox col-md-8  ">

	<div class="panel panel-info">

		<div class="panel-heading">
			<div class="panel-title">Register Or Update Staff Details</div>
		</div>
		<br> <br>
		<div class="container">
			<form:form action="saveOrUpdateStaff" modelAttribute="staff"
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<form:input class="form-control input-sm"
							placeholder="Enter phone number..." path="mobile" />
				...
				<security:authorize access="hasRole('ADMIN')">
					<div class="form-group row">
						...
						<div class="col-sm-3">
							<form:input class="form-control input-sm"
								placeholder="Enter national ID ...." path="nationalID" />
					...
					<div class="form-group row">
						<form:label path="jobTitle.id" class="col-sm-2 col-form-label">Job Title</form:label>
						<div class="col-sm-3">
							<form:select id="inputBorder" class="form-control"
								path="jobTitle.id">
								<option value="a">Select a jobTitle</option>
								<c:forEach items="${jobTitles}" var="jobTitle">
									<option value="${jobTitle.id}">${jobTitle.title}</option>
								</c:forEach>
							</form:select>
							<form:errors path="jobTitle.id" cssClass="error"></form:errors>
						</div>

						<form:label class="col-sm-2  col-form-label"
							path="specialty.specialtyID"> Doctor Specialty(Only for doctors)</form:label>
						<div class="col-sm-3">
							<form:select id="inputBorder" class="form-control"
							...
							<form:errors path="specialty.specialtyID" cssClass="error"></form:errors>
						</div>
					</div>
				</security:authorize>
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<form:select id="inputBorder" class="form-control input-sm"
							...
							<option value="a">Select MaritalStatus</option>
		...
		<div class="panel-footer">
			<div class="panel-title ">Please verify details before save</div>
		</div>
	</div>
</div>
